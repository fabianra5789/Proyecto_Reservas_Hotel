 ...
 * @author Ana Maria
 */
public class VisorImagenServicios extends javax.swing.JFrame {
...
txCerrar.setIcon(new javax.swing.ImageIcon(("/Users/fabianra5789/Documents/torrents/salida.png")));
        for(int a =1; a<8; a++){
           Imagen[a] = new ImageIcon("/Users/fabianra5789/Documents/imagenes/im"+a+".jpg");
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 55, 750, 450));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Timer timer = new Timer (1000, new ActionListener (){
            ...
            public void actionPerformed(ActionEvent e) {
                jLabel1.setIcon(new javax.swing.ImageIcon("/Users/fabianra5789/Documents/imagenes/im"+contador+".jpg"));
                contador ++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisorImagenServicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisorImagenServicios().setVisible(true);
            }
        });
    }
